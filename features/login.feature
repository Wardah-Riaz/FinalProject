...
Scenario: Login
  ...
  And I press "Log in"
  Then I should see "Course Manager Discussion Forum"
  #Then I should see "You Personal Info:-"
...
Scenario: Login
  ...
  And I should see "Course Manager Discussion Forum"
