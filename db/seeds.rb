...
students = [{:email => "Alice_12@gmail.com", :password => "11111", :name => "Alice",:gender => "F", :dob => 23-11-1992},
{:email => "John44@hotmail.com", :password => "22222", :name => "John", :gender => "M", :dob => 25-11-1992},
{:email => "George_90@gmail.com", :password => "33333", :name =>"George" , :gender => "F", :dob => 25-10-1993},
{:email => "lisa@gmail.com", :password => "121212", :name =>"Lisa" , :gender => "F", :dob => 25-8-1993}]
...
instructors = [{:email => "Harris@hotmail.com", :password => "12345", :Full_Name => "M. Harris",:Your_Description => "I'll offer 3 courses", :DoB => 23-11-1992},
{:email => "Danyal@hotmail.com", :password => "67890", :Full_Name => "M. Danyal",:Your_Description => "I am an Instructor ", :DoB => 27-11-1993},
{:email => "Bob@gmail.com", :password => "60606", :Full_Name => "Bob Hudson",:Your_Description => "You'll enjoy my courses", :DoB => 27-11-1993}]
